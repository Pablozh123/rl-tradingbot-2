...
print("Using full 2022 data for validation...")
...
MODEL_PATH = "models/ppo_lstm_parallel_1765916372"
...
try:
    ...
    ax1.set_title('Price Action with Trade Entries & Exits')
    ...
    ax2.set_title('Account Balance Growth')
    ax2.set_xlabel('Steps')
    ax2.set_ylabel('Balance ($)')
    ax2.grid(True, alpha=0.3)
    
    plt.tight_layout()
    plt.savefig('backtest_dashboard.png')
    print("Advanced dashboard saved to 'backtest_dashboard.png'")
